...
{
	public abstract class AbstractSvgCombinationCharGeneratorHorizontal : AbstractSvgCombinationCharGenerator, IGenerator
    {

		public AbstractSvgCombinationCharGeneratorHorizontal()
            : base() {}

        public AbstractSvgCombinationCharGeneratorHorizontal(string symbolsFileName, float charSize, bool useHelp)
